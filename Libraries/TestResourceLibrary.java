...
public class TestResourceLibrary implements IResource {
    ...
    public boolean launchProduct(String productID) {
        // Método obrigatório pela interface IResource
        System.out.println("Biblioteca: Lançando produto " + productID);
        return true;
    }
    ...
    public boolean finishProduct(String productID) {
        // Método obrigatório pela interface IResource
        System.out.println("Biblioteca: Finalizando produto " + productID);
        return true;
    }
}
